...
/**
 * Save report to localStorage and generate PDF
 */
function saveReport() {
  const data = ResultState.productData;
  ...
  showToast("Report saved and PDF generated!", "success");
}
...
function generatePDFReport(data) {
  ...
  const reportHTML = `
    ...
    <html>
    <head>
      <title>NutriTruth Report - ${data.name}</title>
      <style>
        body { font-family: Arial, sans-serif; color: #333; line-height: 1.6; }
        .header { background: linear-gradient(135deg, #10b981 0%, #06b6d4 100%); color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
        .section { margin-bottom: 20px; page-break-inside: avoid; }
        .section-title { font-size: 18px; font-weight: bold; color: #10b981; border-bottom: 2px solid #10b981; padding-bottom: 10px; margin-bottom: 15px; }
        table { width: 100%; border-collapse: collapse; margin-bottom: 15px; }
        th, td { padding: 10px; text-align: left; border-bottom: 1px solid #ddd; }
        th { background-color: #f0f0f0; font-weight: bold; }
        .health-score { font-size: 24px; font-weight: bold; color: #10b981; }
        .warning { color: #ef4444; font-weight: bold; }
        .badge { display: inline-block; padding: 5px 10px; border-radius: 4px; margin-right: 5px; }
        .healthy { background-color: #d1fae5; color: #065f46; }
        .risky { background-color: #fef3c7; color: #92400e; }
    ...
    <body>
      <div class="header">
        <h1>NutriTruth Product Analysis Report</h1>
      ...
      <div class="section">
        <h2 class="section-title">Nutrition Facts (per serving)</h2>
        <table>
      ...
      <div class="footer">
        <p>This report was generated by NutriTruth - Know What You Eat</p>
